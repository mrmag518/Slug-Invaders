...
public class SaltBullet {
    ...
    public void move() {
        switch(direction) {
            case UP: {
                ...
                if(y+bullet.getHeight() < 0) {
                    player.getSaltBulletsInAir().remove(this);
                }
                break;
            }
        ...
        /**
         * This code works, however the salt bullet never disappears!
         * Major headache bug, I have proven that the remove function works, it gets removed, but somehow reappears
         * immediately somehow ... 
         * Any other remove call outside this one works, the bullet is removed. Why does it not work here?????????
         * Makes noooo  sense to me whatsoever. So frustrated right now...................
         */
